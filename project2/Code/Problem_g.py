...
naive_model.fit(train_tfidf_final, train_target_final)
#predicted values in Y_pred
test_predicted = naive_model.predict(test_tfidf_final)
...
#Plotting the ROC
probas_ = naive_model.predict_proba(test_tfidf_final)                                    
